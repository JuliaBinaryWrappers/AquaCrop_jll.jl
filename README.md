# `AquaCrop_jll.jl` (v7.1.1+0)

[![deps](https://juliahub.com/docs/AquaCrop_jll/deps.svg)](https://juliahub.com/ui/Packages/General/AquaCrop_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/535a02ea1585cb80f183921cfe3f883fb2582933/A/AquaCrop/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `AquaCrop_jll.jl` have been built from these sources:

* git repository: https://github.com/KUL-RSDA/AquaCrop (revision: `6b242b6650bce6f1387668aa30f40f0c293a4b8d`)

## Platforms

`AquaCrop_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `AquaCrop_jll.jl`:
...
* `LibraryProduct`: `libaquacrop`
* `ExecutableProduct`: `aquacrop`
